  ...
  render() {
    return (
      <div>
        ...
        <Image imageName={'arc'} bucket={'paris'} caption={'Arc de Triomphe'}/>
        <p>
        ...
        <Image imageName={'room'} bucket={'paris'} caption={'My accommodations'}/>
        <p>
        ...
        <Image imageName={'louvre'} bucket={'paris'} caption={'The Louvre'}/>
        <p>
        ...
        <Image imageName={'tower_2'} bucket={'paris'} caption={'Eiffel Tower'}/>
        <p>
        ...
        <Image imageName={'cafe'} bucket={'paris'} caption={'Cafe where I enjoyed some excellent steak & wine and some bad fries'}/>
        <p>
        ...
        <Image imageName={'dame'} bucket={'paris'} caption={'Paris Notre-Dame'}/>
        <p>
        ...
        <Image imageName={'mont'} bucket={'paris'} caption={'View from Montmartre towards the Eiffel Tower'}/>
      </div>
    )
  }
}
